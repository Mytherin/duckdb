...
static HighlightElement highlight_elements[] = {
    ...
    {"explain_operator_join", PrintColor::DEEPSKYBLUE1, PrintIntensity::BOLD},
    {"explain_operator_aggregate", PrintColor::DARKORANGE, PrintIntensity::BOLD},
    {"explain_operator_order", PrintColor::VIOLET, PrintIntensity::BOLD},
    ...
    {"explain_subtree_ref", PrintColor::CYAN, PrintIntensity::BOLD},
