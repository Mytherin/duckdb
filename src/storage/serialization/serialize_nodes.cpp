...
void CommonTableExpressionMap::Serialize(Serializer &serializer) const {
	serializer.WritePropertyWithDefault<
	    InsertionOrderPreservingMap<unique_ptr<CommonTableExpressionInfo>, Identifier, IdentifierMap<idx_t>>>(
	    100, "map", map);
}
...
void SerializedCSVReaderOptions::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<IdentifierMap<idx_t>>(135, "sql_types_per_column",
...
SerializedCSVReaderOptions SerializedCSVReaderOptions::Deserialize(Deserializer &deserializer) {
	...
	auto options_sql_types_per_column =
	    deserializer.ReadPropertyWithDefault<IdentifierMap<idx_t>>(135, "sql_types_per_column");
