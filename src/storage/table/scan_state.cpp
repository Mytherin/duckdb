...
void TableScanState::Initialize(vector<PhysicalIndex> column_ids, TableFilterSet *table_filters) {
...
const vector<PhysicalIndex> &TableScanState::GetColumnIds() {
...
const vector<PhysicalIndex> &CollectionScanState::GetColumnIds() {
