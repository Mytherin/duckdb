...
public:
	...
	//! can be skipped.
	bool CheckZonemap(TableFilterSet &filters, const vector<PhysicalIndex> &column_ids);
	...
	void FetchRow(TransactionData transaction, ColumnFetchState &state, const vector<PhysicalIndex> &column_ids,
