...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"ColumnDefinition <- DottedIdentifier Type? GeneratedColumn? IdentityColumn? ConstraintNameClause? ColumnConstraint*\n"
	...
	"IdentityColumn <- 'GENERATED' 'ALWAYS' 'AS' 'IDENTITY' Parens(SequenceOption*)?\n"
