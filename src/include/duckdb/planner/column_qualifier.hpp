...
public:
	...
	void QualifyColumnNamesInLambda(FunctionExpression &function, vector<IdentifierSet> &lambda_params);
	...
	void QualifyColumnNames(unique_ptr<ParsedExpression> &expr, vector<IdentifierSet> &lambda_params,
