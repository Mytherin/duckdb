...
struct SelectBindState {
	...
	IdentifierMap<idx_t> alias_map {IdentifierConstructor::NO_CLIENT_CONTEXT};
	...
	IdentifierMap<ProjectionIndex> group_alias_map {IdentifierConstructor::NO_CLIENT_CONTEXT};
