...
public:
	...
	explicit VectorListBuffer(capacity_t capacity, const LogicalType &list_type,
	                          capacity_t child_capacity = capacity_t(STANDARD_VECTOR_SIZE));
	explicit VectorListBuffer(data_ptr_t data, capacity_t capacity, const Vector &vector);
	explicit VectorListBuffer(data_ptr_t data, capacity_t capacity, const VectorListBuffer &parent);
	explicit VectorListBuffer(AllocatedData allocated_data, const VectorListBuffer &parent);
	explicit VectorListBuffer(AllocatedData allocated_data, VectorListBuffer &parent);
