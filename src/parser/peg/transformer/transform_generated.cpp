...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformQualifiedSequenceNameInternal(
	...
	if (schema_qualification_opt.HasResult()) {
		...
		for (auto &schema_qualification_value_item_1 : schema_qualification_value_repeat_1.GetChildren()) {
			auto schema_qualification_value_value_1 = transformer.Transform<Identifier>(schema_qualification_value_item_1.get());
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformCatalogReservedSchemaTypeNameInternal(
	...
	for (auto &reserved_schema_qualification_item : reserved_schema_qualification_repeat.GetChildren()) {
		auto reserved_schema_qualification_value = transformer.Transform<Identifier>(reserved_schema_qualification_item.get());
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformCatalogReservedSchemaFunctionNameInternal(
	...
	if (reserved_schema_qualification_opt.HasResult()) {
		...
		auto &reserved_schema_qualification_value_repeat_1 = reserved_schema_qualification_opt.GetResult().Cast<RepeatParseResult>();
		for (auto &reserved_schema_qualification_value_item_1 : reserved_schema_qualification_value_repeat_1.GetChildren()) {
			auto reserved_schema_qualification_value_value_1 = transformer.Transform<Identifier>(reserved_schema_qualification_value_item_1.get());
