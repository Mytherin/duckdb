...
void ChildFieldIDs::Serialize(Serializer &serializer) const {
	serializer.WritePropertyWithDefault<IdentifierMap<FieldID>>(100, "ids", ids.operator*());
}

ChildFieldIDs ChildFieldIDs::Deserialize(Deserializer &deserializer) {
	ChildFieldIDs result;
	deserializer.ReadPropertyWithDefault<IdentifierMap<FieldID>>(100, "ids", result.ids.operator*());
	return result;
}

void ChildShreddingTypes::Serialize(Serializer &serializer) const {
	serializer.WritePropertyWithDefault<IdentifierMap<ShreddingType>>(100, "types", types.operator*());
}

ChildShreddingTypes ChildShreddingTypes::Deserialize(Deserializer &deserializer) {
	ChildShreddingTypes result;
	deserializer.ReadPropertyWithDefault<IdentifierMap<ShreddingType>>(100, "types", result.types.operator*());
	return result;
}
