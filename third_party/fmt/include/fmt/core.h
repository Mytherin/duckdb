...
inline fmt_uint128_t operator-(int lhs, fmt_uint128_t rhs) {
  return fmt_uint128_t(static_cast<uint64_t>(lhs)) - rhs;
}

inline char operator+(char c, fmt_uint128_t rhs) {
  return static_cast<char>(c + static_cast<int64_t>(rhs));
}
